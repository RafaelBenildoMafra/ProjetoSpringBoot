package com.mafracompany.course.config;
...
import com.mafracompany.course.repositories.OrderItemRepository;
...
@Configuration
@Profile("test") //igual o nome colocado no profile
//POPULA O BANCO DE DADOS COM OBJETOS
public class TesteConfig implements CommandLineRunner{
	...
	//EXECUTA QUANDO A APLICAÇÃO FOR INICIADA PORCAUSA DO METODO RUN
	@Override
